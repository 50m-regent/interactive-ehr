...
- TraceBench-EHR v1.1のvalidationパイロットまでを確認済みの結果として記載しています。
- validationでは924件の基準ケースから758組、6,064候補を生成し、8種類の変異が事前の停止条件を満たしました。
- test splitは未実行です。4条件の性能差と修復成功率は未確定として記載しています。
